    ...
    draw() {
        ...
        switch (this.num) {
            case 0:
                {
                    let lock = false;
                    let button = Helper.create_element('a', {
                        class: 'button woof-button-outline-secondary woof-sd-create-element',
            ...
            case 1:
                {
                    {
                        let button = Helper.create_element('a', {
                            class: 'button woof-button-outline-secondary woof-sd-btn-back'
                        }, woof_sd.lang.back, {
                            name: 'click',
                            callback: e => {
...

                    {
                        let select = Helper.create_html_select(this.sd.demo_taxonomies, this.sd.selected_demo_taxonomy, {
                            class: 'woof-sd-select-demo-taxonomies'
                        }, {
                            name: 'change',
